  ...
  return (
    <div className="min-h-40 lg:min-h-[20rem] w-full">
      <div className="h-72 relative w-full">
        ...
        <div className="flex flex-col items-center justify-center mb-20 text-black">
          <div className="flex flex-col items-center justify-center mb-10 gap-5 text-sm font-light">
